...
_C.SIM.TRAIN = "/cephfs/datasets/iccv_pnp/messy-table-datasets/v12/training_lists/all_train.txt"  # training lists of your training datasets
_C.SIM.VAL = "/cephfs/datasets/iccv_pnp/messy-table-datasets/v12/training_lists/all_val.txt"  # training lists of your validation datasets
_C.SIM.TESTSET = '/cephfs/datasets/iccv_pnp/messy-table-datasets/real_v9/training/'
_C.SIM.TEST = "/cephfs/datasets/iccv_pnp/messy-table-datasets/real_v9/training_lists/all.txt"
