...
_C.MODEL.CROP_WIDTH = 256  # crop width
...
# Split files
_C.SIM = CN()
_C.SIM.DATASET = "/cephfs/datasets/iccv_pnp/messy-table-datasets/v12/training/"  #  directory of your training datasets
_C.SIM.TRAIN = "/home/wanglei/data/first/list_14/train.txt"  # training lists of your training datasets
_C.SIM.VAL = "/home/wanglei/data/first/list_14/val.txt"  # training lists of your validation datasets
_C.SIM.TESTSET = '/cephfs/datasets/iccv_pnp/messy-table-datasets/real_v9/training/'
_C.SIM.TEST = "/home/wanglei/data/first/list_14/test.txt"
...
_C.REAL = CN()
_C.REAL.TEST = '/cephfs/datasets/iccv_pnp/messy-table-datasets/real_v9/training_lists/all.txt'
_C.REAL.TRAIN = "/cephfs/datasets/iccv_pnp/messy-table-datasets/rand_scenes/train_list.txt"
_C.REAL.LABELSET = "/cephfs/datasets/iccv_pnp/real_data_v9/"
_C.REAL.TESTSET =  '/cephfs/datasets/iccv_pnp/messy-table-datasets/real_data_v10_temp/'
_C.REAL.DATASET = "/cephfs/datasets/iccv_pnp/messy-table-datasets/rand_scenes/rand_scenes/"  # path to your real testing datasets
