...
_C.SIM.TRAIN = "/root/wl/data/first/list_28/train.txt"  # training lists of your training datasets
_C.SIM.VAL = "/root/wl/data/first/list_28/val.txt"  # training lists of your validation datasets
_C.SIM.TESTSET = '/cephfs/datasets/iccv_pnp/messy-table-datasets/real_v9/training/'
_C.SIM.TEST = "/root/wl/data/first/list_28/test.txt"
...
_C.SOLVER.BATCH_SIZE = 12 # batch size
