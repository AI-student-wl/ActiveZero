...
parser.add_argument(
    "--split-file",
    type=str,
    default="/cephfs/datasets/iccv_pnp/messy-table-datasets/rand_scenes/train_list.txt",
    metavar="FILE",
)
parser.add_argument(
    "--data-folder",
    type=str,
    default="/cephfs/datasets/iccv_pnp/messy-table-datasets/rand_scenes/rand_scenes",
)
